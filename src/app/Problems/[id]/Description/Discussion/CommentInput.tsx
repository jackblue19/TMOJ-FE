...
export const CommentInput = ({
  ...
  <div
    className={`bg-white border border-gray-200 rounded-2xl p-4 shadow-sm focus-within:border-gray-400 transition-all ${
      isReply ? "bg-gray-50 mt-4" : "mb-10"
    }`}
  >
    {isReply && (
    ...
    <div className="flex justify-between items-center mt-2 border-t pt-3">
      <div className="flex gap-4 text-gray-400 items-center">
        ...
        <Tooltip content="Mention" size="sm">
      ...
      <div className="flex gap-2">
        ...
        <Button
          size="sm"
          className="bg-[#2cbb5d] text-white font-bold px-6 rounded-lg h-8"
        >
