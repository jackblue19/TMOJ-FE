  ...
  return (
    <Navbar maxWidth="full" className="px-6">
     ...
     <NavbarContent className="gap-6" justify="start">
        ...
        <NavbarItem><Link color="danger" href="/Explore">Explore</Link></NavbarItem>
        <NavbarItem><Link color="danger" href="/Problems">Problems</Link></NavbarItem>
        <NavbarItem><Link color="danger" href="/Contest">Contest</Link></NavbarItem>
        <NavbarItem><Link color="danger" href="/Discuss">Discuss</Link></NavbarItem>
        <Dropdown>
  <NavbarItem>
    <DropdownTrigger>
      <Button
